...
export function GoogleButton({
  ...
  return (
    <Button
      ...
      type="button"
      size="lg"
      className="w-full h-12 rounded-lg bg-white hover:bg-gray-50 dark:bg-white/5 dark:hover:bg-white/10 border-2 border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500 !text-gray-800 hover:!text-gray-800 dark:!text-gray-100 dark:hover:!text-gray-100 font-semibold shadow-sm hover:shadow-md transition-all duration-200 active:scale-[0.98]"
      onClick={onClick}
      disabled={disabled}
    >
      {isLoading ? (
